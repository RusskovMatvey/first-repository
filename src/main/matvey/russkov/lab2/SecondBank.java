...
public interface SecondBank extends ExchangeRate {
    double USD_EXCHANGE_RATE_BUY = 66.09;
    double EUR_EXCHANGE_RATE_BUY = 75.00;
    double USD_EXCHANGE_RATE_SELL = 65.31;
