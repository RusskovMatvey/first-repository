...
public interface FourthBank extends ExchangeRate {
    double USD_EXCHANGE_RATE_BUY = 66.86;
    double EUR_EXCHANGE_RATE_BUY = 75.54;
    double USD_EXCHANGE_RATE_SELL = 65.86;
